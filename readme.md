...
> An up-to-date and meticulously curated collection of quantum programming algorithms, complexity analysis, hackathons, programming tutorials, programming books, and other resources tailored for programmers to learn to build and interface with quantum software as well as track new quantum algorithms and programming techniques. 
